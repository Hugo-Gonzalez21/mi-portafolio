...
const Footer: React.FC = () => {
    return (
        <footer id='contact'>
            <div className="bg-gray-800 text-white text-center py-4 flex flex-col items-center">
                <p>&copy; Hugo González. Todos los derechos reservados.</p>
                <div className="flex gap-4 mt-2 ">
                    <a href="https://github.com/Hugo-Gonzalez21"
                        target="_blank"
                    ...
                    <a
                        href="https://www.linkedin.com/in/hugo-gonzalez21"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block p-2 rounded-full"
                        aria-label="LinkedIn"
